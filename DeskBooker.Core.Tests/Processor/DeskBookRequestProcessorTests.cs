...
namespace DeskBooker.Core.Processor
{
    public class DeskBookRequestProcessorTests
    {
        ...
        public void ShouldSaveDeskBooking()
        {
            ...
            _deskBookingRepositoryMock.Setup(x => x
                .Save(It.IsAny<DeskBooking>()))
            ...
            _deskBookingRepositoryMock.Verify(x => x
                .Save(It.IsAny<DeskBooking>()), Times.Once);
        ...
        public void ShouldNotSaveDeskBookingIfNoDeskIsAvailable()
        {
            ...
            _processor.BookDesk(_request);
            _deskBookingRepositoryMock.Verify(x => x
                .Save(It.IsAny<DeskBooking>()), Times.Never);
        ...
        public void ShouldReturnExpectedBookId(int? expectedDeskBookingId, bool isDeskAvailable)
        {
            if (!isDeskAvailable)
            {
                _availableDesks.Clear();
